...
export CF_Email="senyz2014@gmail.com"
...
~/.acme.sh/acme.sh --issue -d senyzlife.top --standalone -k ec-256
...
mkdir -p /etc/v2ray
~/.acme.sh/acme.sh --installcert -d senyzlife.top \
